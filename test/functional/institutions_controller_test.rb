...
class InstitutionsControllerTest < ActionController::TestCase
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post :create, institution: { address: @institution.address, city: @institution.city, name: @institution.name, state: @institution.state }
    end
  ...
  test "should update institution" do
    put :update, id: @institution, institution: { address: @institution.address, city: @institution.city, name: @institution.name, state: @institution.state }
    assert_redirected_to institution_path(assigns(:institution))
  end
